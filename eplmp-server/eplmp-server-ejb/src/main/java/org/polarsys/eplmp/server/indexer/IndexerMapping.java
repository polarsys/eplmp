...
public class IndexerMapping {
    ...
    private static final String DOCUMENT_MAPPING_RESOURCE = "/org/polarsys/eplmp/server/indexer/document-mapping.json";
    private static final String PART_MAPPING_RESOURCE = "/org/polarsys/eplmp/server/indexer/part-mapping.json";
    private static final String SOURCE_MAPPING_RESOURCE = "/org/polarsys/eplmp/server/indexer/source-mapping.json";
