...
public interface IProductInstanceManagerLocal {
    ...
    PathDataMaster getPathDataByPathIdAndProductInstanceIteration(String workspaceId, int pathId, ProductInstanceIteration productInstanceIteration) throws PathDataMasterNotFoundException, UserNotFoundException, UserNotActiveException, WorkspaceNotFoundException, WorkspaceNotEnabledException;
