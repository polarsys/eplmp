...
@Entity
@NamedQueries({
        @NamedQuery(name="ProductBaseline.findByWorkspace",query="SELECT b FROM ProductBaseline b WHERE b.configurationItem.workspace.id = :workspaceId ORDER BY b.name"),
